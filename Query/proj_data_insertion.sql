...
('서비스 전환', NOW(), 15, @migration_proj_id, 'GITHUB', 'ServiceChange_Repo', 'https://github.com/syncday/migration/service');
...
VALUES
    ...
    ('[팀게시글] 팀 게시글 CRUD 기능 추가', '팀 게시글 CRUD 기능을 추가했습니다. 조회 시 게시글 페이지 처리를 위한 PageHelper 의존성을 추가했습니다.\n테스트코드는 일정 상 추후 작성 예정입니다. Postman을 통한 테스트는 완료했습니다.', NOW(), '2024-06-01 00:00:00', '2024-06-14 23:59:59', 'Pull Request', 'https://github.com/three-ping/SyncDay_Back/pull/117', 10, 8, 10, 11),
    ('[팀게시판] 팀 게시판 CRUD 기능 추가', '팀 게시판 CRUD 기능을 추가하였습니다. 일정 상 테스트 코드는 추후에 작성 예정입니다. 포스트맨을 통한 테스트 모두 완료하였습니다.', NOW(), '2024-06-15 00:00:00', '2024-06-30 23:59:59', 'Pull Request', 'https://github.com/three-ping/SyncDay_Back/pull/116', 2, 9, 11, 1),
    ...
    ('[Cardboard] 생성 및 테스트코드', '다중 리전 캐시 시스템 구축', NOW(), '2024-11-15 00:00:00', '2024-11-30 23:59:59', 'Pull Request', 'https://github.com/three-ping/SyncDay_Back/pull/86', 9, 6, 11, 11),
